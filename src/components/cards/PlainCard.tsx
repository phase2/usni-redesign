...
export default function PlainCard({ headline, body, cta, href }: PlainCardProps) {
  return (
    <div className="flex flex-col border border-navy-bolder/20 bg-white p-6 lg:p-7">
      <h3 className="font-headline text-2xl text-navy-bolder leading-tight mb-4">{headline}</h3>
      <p className="font-body text-sm text-navy leading-relaxed mb-8 flex-1">{body}</p>
      <a
        href={href}
