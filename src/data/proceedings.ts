...
export const featuredArticlesRight: Article[] = [
  {
    ...
    excerpt: 'Digital, physical, and biological technologies are reshaping militaries; the Navy must take charge.',
    date: 'April 2026',
    author: 'Colonel Pat Garrett, U.S. Marine Corps (Retired), and Lieutenant Colonel Frank Hoffman, U.S. Marine Corps Reserve (Retired)',
    image: imgNeptune,
  ...
  },
  {
    ...
    excerpt: 'The next war is unlikely to be short and sharp, and the Marine Corps must be ready to reconstitute and expand its force.',
    date: 'April 2026',
...
export const latestIssueCol1: Article[] = [
  {
    ...
    excerpt: "The United States must understand how Russia wages its 'new generation' warfare. Europe is already under attack.",
    date: 'April 2026',
  ...
  },
  {
    ...
    excerpt: 'U.S. maritime dominance requires a broader set of means than those provided solely by naval power.',
    date: 'April 2026',
    author: 'Bruce Stubbs',
  ...
  },
  {
    ...
    excerpt: "A failed offensive in Russia's perpetual information war against the West.",
    date: 'April 2026',
  ...
  },
  {
    ...
    excerpt: 'The United States has insisted on a free and open Strait of Hormuz for decades. It should not back away from that principled position now.',
    date: 'April 2026',
  ...
  },
  {
    ...
    excerpt: 'The ground operations the United States is considering carry significant tactical and operational risks and major strategic flaws.',
    date: 'April 2026',
    author: 'Brandon Carr',
...
export const latestIssueCol2: Article[] = [
  {
    ...
    excerpt: "The next conflict may begin in cyberspace, with an attack that targets U.S. civilian infrastructure, daily life, and the joint force's ability to project combat power abroad.",
    date: 'April 2026',
  ...
  },
  {
    ...
    excerpt: 'China is obsessed with maintaining at least a thin veneer of adherence to international law.',
    date: 'April 2026',
  ...
  },
  {
    ...
    excerpt: 'Modern naval platforms are marvels of engineering—and nightmares of logistics.',
    date: 'April 2026',
  ...
  },
  {
    ...
    excerpt: 'For the FF(X) program to succeed, the Navy must heed the lessons of the LCS, Zumwalt, and Constellation classes.',
    date: 'April 2026',
